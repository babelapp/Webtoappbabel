...
class Config {
  ...
  /// Generated by SiteNative 20-06-2022 05:57:39
  /// App UID: d23748f7-e4ee-d867-e38b-b385b81ca4ac
  /// Version: https://web2app.babelcorporation.com/backend/
  /// API server: {VERSION}

  /// *** App config *** ///
  // App name
  static String appName = "Babel";
  // App link
  static String appLink = "https://babelcorporation.com/";
  ...
  /// *** Drawer settings *** ///
  // Title
  static String drawerTitle = "Babel App";
  // Subtitle
  static String drawerSubtitle = "Test App";
  // Background mode
  ...
  // Signing
  static String osSigning = "2eaa1849f83b0736c108c528e51a310c4c15674b155954828e3eed2bea8cb926";
  // Enabled android?
  ...
  static List<NavigationItem> mainNavigation = [
    	NavigationItem(name: "Home",icon: "home-outline.svg",type: ActionType.internal,value: "https://webtoapp.babelcorporation.com/",),

  ];
  // Bar app navigation
  static List<NavigationItem> barNavigation = [
    	NavigationItem(name: "Home",icon: "albums-outline.svg",type: ActionType.internal,value: "https://webtoapp.babelcorporation.com/",),

  ];
  // Modal navigation
  static List<NavigationItem> modalNavigation = [
    	NavigationItem(name: "House",icon: "airplane.svg",type: ActionType.internal,value: "https://webtoapp.babelcorporation.com/",),
